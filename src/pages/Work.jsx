...
export default function WorkPage() {
  ...
  return (
    <section className="fixed flex items-center justify-center min-h-screen bg-black text-white">
      ...
      <div className="fixed w-full max-w-screen-xl h-[800px] overflow-y-scroll no-scrollbar rounded-lg shadow-lg border-4 px-12 py-16 grid grid-cols-1 sm:grid-cols-2 gap-8 z-20">
        {/* Card 1 */}
        <div
